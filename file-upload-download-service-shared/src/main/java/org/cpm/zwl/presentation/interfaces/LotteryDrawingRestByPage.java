...
public interface LotteryDrawingRestByPage {
	...
	JsonResponse<P1Vos> p1(@RequestParam(value="userId") String userId) throws FudsBaseException;
	...
	JsonResponse<P2Vos> p2(@RequestParam(value="userId") String userId, @RequestParam(value="gameId") String gameId) throws FudsBaseException;
	...
	JsonResponse<P2DrawLotteryVos> p2DrawLottery(@RequestParam(value="userId") String userId, @RequestParam(value="gameId") String gameId) throws FudsBaseException;
	...
	JsonResponse<P3Vos> p3(@RequestParam(value="userId") String userId, @RequestParam(value="gameId") String gameId) throws FudsBaseException;
